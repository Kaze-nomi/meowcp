function(as_library)
    ...
    file(GLOB HEADERS_LIB include/*.h*)
    add_library(${PROJECT_NAME} STATIC ${SOURCE_LIB} ${HEADERS_LIB})
    set(${PROJECT_NAME}_INCLUDE_DIRS ${PROJECT_SOURCE_DIR}/include
            CACHE INTERNAL "${PROJECT_NAME}: Include Directories" FORCE)
    include_directories(${${PROJECT_NAME}_INCLUDE_DIRS})
endfunction()

function(as_interface_library)
    file(GLOB HEADERS_LIB include/*.h*)
    add_library(${PROJECT_NAME} INTERFACE)
    target_sources(${PROJECT_NAME} INTERFACE ${HEADERS_LIB})
    set(${PROJECT_NAME}_INCLUDE_DIRS ${PROJECT_SOURCE_DIR}/include
            CACHE INTERNAL "${PROJECT_NAME}: Include Directories" FORCE)
    include_directories(${${PROJECT_NAME}_INCLUDE_DIRS})
